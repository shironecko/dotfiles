...
local on_attach = function(client, bufnr)
  ...
  vimp.add_buffer_maps(bufnr, function()
    ...
    vimp.nnoremap('<leader>wa', vim.lsp.buf.add_workspace_folder)
    vimp.nnoremap('<leader>wr', vim.lsp.buf.remove_workspace_folder)
    vimp.nnoremap('<leader>wl', function()
      print(vim.inspect(vim.lsp.buf.list_workspace_folders))
    end)
    vimp.nnoremap('<leader>D', vim.lsp.buf.type_definition)
    vimp.nnoremap('<leader>rn', vim.lsp.buf.rename)
    vimp.nnoremap('<leader>e', vim.lsp.diagnostic.show_line_diagnostics)
    vimp.nnoremap('[d', vim.lsp.diagnostic.goto_prev)
    vimp.nnoremap(']d', vim.lsp.diagnostic.goto_next)
    vimp.nnoremap('<leader>q', vim.lsp.diagnostic.set_loclist)
    vimp.nnoremap('<leader>rf', vim.lsp.buf.formatting)
  end)
end
...
local rust_on_attach = function(client, bufnr)
  ...
  vimp.add_buffer_maps(bufnr, function()
    ...
    vimp.nnoremap('<leader>br', function()
